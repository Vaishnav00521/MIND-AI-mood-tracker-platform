...
import { LayoutDashboard, CheckSquare, CalendarDays, BrainCircuit, LogOut, HeartPulse, Building2, Target, Grid3X3, MessageSquareText, ShieldCheck, Sparkles, Globe } from 'lucide-react';
...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white selection:bg-purple-500/30 selection:text-white relative overflow-hidden">
      ...
      <aside className="hidden md:flex flex-col w-72 bg-gray-900/40 backdrop-blur-2xl border-r border-white/10 z-20">
        ...
        <div className="p-6 border-t border-white/10 flex-shrink-0">
          <a href="/login" className="flex items-center gap-3 px-4 py-3 rounded-xl text-red-400 hover:bg-red-500/10 hover:border-red-500/20 transition-all font-medium border border-transparent">
      ...
      <main className="flex-1 overflow-y-auto w-full relative z-10">
         ...
         <div className="md:hidden bg-gray-900/60 backdrop-blur-xl border-b border-white/10 p-4 flex justify-between items-center sticky top-0 z-50 shadow-lg">
            ...
            <div className="flex items-center gap-3">
                <LanguageSelector />
                <a href="/login"><LogOut className="text-red-400" size={20}/></a>
            </div>
         </div>
